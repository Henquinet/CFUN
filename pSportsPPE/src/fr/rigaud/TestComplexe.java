...
public class TestComplexe {
	private static int nbMuscu = 20;
	private static int nbFit = 20;
	private static final String nomComplexe = "C Fun";
	private static final String TYPE = "Type op�ration (E)ntr�e ou (S)ortie : ";
	private static final String SORTIE = "N� d'entr�e à sortir : ";
